...
void _noteSerialize(
  ...
  writer.writeDateTime(offsets[2], object.lastEdit);
...
Note _noteDeserialize(
  ...
  object.id = id;
  object.lastEdit = reader.readDateTimeOrNull(offsets[2]);
...
extension NoteQueryFilter on QueryBuilder<Note, Note, QFilterCondition> {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastEditIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'lastEdit',
      ));
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastEditIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'lastEdit',
      ));
